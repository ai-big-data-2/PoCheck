...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        video_capture = cv2.VideoCapture('http://141.223.140.58:8080/video')
        c = 0
            ...
            if (c % timeF == 0):
                ...
                if nrof_faces > 0:
                    ...
                    for i in range(nrof_faces):
                        ...
                        cropped[i] = facenet.flip(cropped[i], True)
                        ...
                        print(result_names)
                        cv2.putText(frame, result_names + " " + str(np.round(best_class_probabilities,2)) , (text_x, text_y), cv2.FONT_HERSHEY_COMPLEX_SMALL,
                                    1, (0, 0, 255), thickness=1, lineType=2)
                        #
